...
#include"../../GameObject/UI/Text/Number/NumFour/NumFour.h"
#include"../../GameObject/UI/Text/Number/NumFive/NumFive.h"
...
void StageSelectScene::Init()
{
	...
	//=======================================================================//
	//ステージ４用
	std::shared_ptr<StageFrame> stageFrame4 = std::make_shared<StageFrame>();
	stageFrame4->Init("Asset/Data/Json/UI/Frame/StageFrame/StageFrame4/StageFrame4.json");
	AddObject(stageFrame4);

	std::shared_ptr<NumFour> numFour = std::make_shared<NumFour>();
	numFour->Init("Asset/Data/Json/UI/Text/Number/NumFour/NumFour.json");
	AddObject(numFour);
	//=======================================================================//

	//=======================================================================//
	//ステージ５用
	std::shared_ptr<StageFrame> stageFrame5 = std::make_shared<StageFrame>();
	stageFrame5->Init("Asset/Data/Json/UI/Frame/StageFrame/StageFrame5/StageFrame5.json");
	AddObject(stageFrame5);

	std::shared_ptr<NumFive> numFive = std::make_shared<NumFive>();
	numFive->Init("Asset/Data/Json/UI/Text/Number/NumFive/NumFive.json");
	AddObject(numFive);
	//=======================================================================//
