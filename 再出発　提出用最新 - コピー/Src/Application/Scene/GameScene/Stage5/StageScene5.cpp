...
void StageScene5::Event()
{
	
}

void StageScene5::Init()
{
	//ステージ切り替え時エフェクト初期化
	...
	stage->Init("Asset/Data/Json/Stage/Stage5/Stage5.json","Stage5");
	AddObject(stage);

	//ゴール
	int goalID = 1;
	std::shared_ptr<GoalPoint> goalPoint = std::make_shared<GoalPoint>();
	goalPoint->Init("Asset/Data/Json/Stage/Stage5/GoalPoint/GoalPoint.json", goalID++);
	AddObject(goalPoint);

	//プレイヤー
	std::shared_ptr<Player> player = std::make_shared<Player>();
	player->Init("Asset/Data/Json/Player/Stage5/Player.json");
	AddObject(player);
	...
	blueBlock1->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock1.json", blockID++);
	AddObject(blueBlock1);

	std::shared_ptr<BlueBlock> blueBlock2 = std::make_shared<BlueBlock>();
	blueBlock2->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock2.json", blockID++);
	AddObject(blueBlock2);

	std::shared_ptr<BlueBlock> blueBlock3 = std::make_shared<BlueBlock>();
	blueBlock3->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock3.json", blockID++);
	AddObject(blueBlock3);

	std::shared_ptr<BlueBlock> blueBlock4 = std::make_shared<BlueBlock>();
	blueBlock4->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock4.json", blockID++);
	AddObject(blueBlock4);

	std::shared_ptr<BlueBlock> blueBlock5 = std::make_shared<BlueBlock>();
	blueBlock5->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock5.json", blockID++);
	AddObject(blueBlock5);

	std::shared_ptr<BlueBlock> blueBlock6 = std::make_shared<BlueBlock>();
	blueBlock6->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock6.json", blockID++);
	AddObject(blueBlock6);

	std::shared_ptr<BlueBlock> blueBlock7 = std::make_shared<BlueBlock>();
	blueBlock7->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock7.json", blockID++);
	AddObject(blueBlock7);

	std::shared_ptr<BlueBlock> blueBlock8 = std::make_shared<BlueBlock>();
	blueBlock8->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock8.json", blockID++);
	AddObject(blueBlock8);

	std::shared_ptr<BlueBlock> blueBlock9 = std::make_shared<BlueBlock>();
	blueBlock9->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock9.json", blockID++);
	AddObject(blueBlock9);

	std::shared_ptr<BlueBlock> blueBlock10 = std::make_shared<BlueBlock>();
	blueBlock10->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock10.json", blockID++);
	AddObject(blueBlock10);

	std::shared_ptr<BlueBlock> blueBlock11 = std::make_shared<BlueBlock>();
	blueBlock11->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock11.json", blockID++);
	AddObject(blueBlock11);

	std::shared_ptr<BlueBlock> blueBlock12 = std::make_shared<BlueBlock>();
	blueBlock12->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock12.json", blockID++);
	AddObject(blueBlock12);

	std::shared_ptr<BlueBlock> blueBlock13 = std::make_shared<BlueBlock>();
	blueBlock13->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock13.json", blockID++);
	AddObject(blueBlock13);

	std::shared_ptr<BlueBlock> blueBlock14 = std::make_shared<BlueBlock>();
	blueBlock14->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock14.json", blockID++);
	AddObject(blueBlock14);

	std::shared_ptr<BlueBlock> blueBlock15 = std::make_shared<BlueBlock>();
	blueBlock15->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock15.json", blockID++);
	AddObject(blueBlock15);

	std::shared_ptr<BlueBlock> blueBlock16 = std::make_shared<BlueBlock>();
	blueBlock16->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock16.json", blockID++);
	AddObject(blueBlock16);

	std::shared_ptr<BlueBlock> blueBlock17 = std::make_shared<BlueBlock>();
	blueBlock17->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock17.json", blockID++);
	AddObject(blueBlock17);

	std::shared_ptr<BlueBlock> blueBlock18 = std::make_shared<BlueBlock>();
	blueBlock18->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock18.json", blockID++);
	AddObject(blueBlock18);

	std::shared_ptr<BlueBlock> blueBlock19 = std::make_shared<BlueBlock>();
	blueBlock19->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock19.json", blockID++);
	AddObject(blueBlock19);

	std::shared_ptr<BlueBlock> blueBlock20 = std::make_shared<BlueBlock>();
	blueBlock20->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock20.json", blockID++);
	AddObject(blueBlock20);

	std::shared_ptr<BlueBlock> blueBlock21 = std::make_shared<BlueBlock>();
	blueBlock21->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock21.json", blockID++);
	AddObject(blueBlock21);

	std::shared_ptr<BlueBlock> blueBlock22 = std::make_shared<BlueBlock>();
	blueBlock22->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock22.json", blockID++);
	AddObject(blueBlock22);

	std::shared_ptr<BlueBlock> blueBlock23 = std::make_shared<BlueBlock>();
	blueBlock23->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock23.json", blockID++);
	AddObject(blueBlock23);

	std::shared_ptr<BlueBlock> blueBlock24 = std::make_shared<BlueBlock>();
	blueBlock24->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock24.json", blockID++);
	AddObject(blueBlock24);

	std::shared_ptr<BlueBlock> blueBlock25 = std::make_shared<BlueBlock>();
	blueBlock25->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock25.json", blockID++);
	AddObject(blueBlock25);

	std::shared_ptr<BlueBlock> blueBlock26 = std::make_shared<BlueBlock>();
	blueBlock26->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock26.json", blockID++);
	AddObject(blueBlock26);

	std::shared_ptr<BlueBlock> blueBlock27 = std::make_shared<BlueBlock>();
	blueBlock27->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock27.json", blockID++);
	AddObject(blueBlock27);

	std::shared_ptr<BlueBlock> blueBlock28 = std::make_shared<BlueBlock>();
	blueBlock28->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock28.json", blockID++);
	AddObject(blueBlock28);

	std::shared_ptr<BlueBlock> blueBlock29 = std::make_shared<BlueBlock>();
	blueBlock29->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock29.json", blockID++);
	AddObject(blueBlock29);

	std::shared_ptr<BlueBlock> blueBlock30 = std::make_shared<BlueBlock>();
	blueBlock30->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock30.json", blockID++);
	AddObject(blueBlock30);

	std::shared_ptr<BlueBlock> blueBlock31 = std::make_shared<BlueBlock>();
	blueBlock31->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock31.json", blockID++);
	AddObject(blueBlock31);

	std::shared_ptr<BlueBlock> blueBlock32 = std::make_shared<BlueBlock>();
	blueBlock32->Init("Asset/Data/Json/Stage/Stage5/BlueBlock/BlueBlock32.json", blockID++);
	AddObject(blueBlock32);
	//=================ブロック=================//

	//フェンス
	int fenceID = 1;
	std::shared_ptr<Fence> fence1 = std::make_shared<Fence>();
	fence1->Init("Asset/Data/Json/Stage/Stage5/Fence/Fence1.json", fenceID++);
	AddObject(fence1);

	std::shared_ptr<Fence> fence2 = std::make_shared<Fence>();
	fence2->Init("Asset/Data/Json/Stage/Stage5/Fence/Fence2.json", fenceID++);
	AddObject(fence2);

	//=================感圧式スイッチ=================//
	int blockPlateID = 1;
	std::shared_ptr<BlockPlate> blockPlate1 = std::make_shared<BlockPlate>();
	blockPlate1->Init("Asset/Data/Json/Stage/Stage5/PressurePlate/BlockPlate/BlockPlate1.json", blockPlateID++);
	//ブロックの情報を渡す
	...
	blockPlate1->AddBlueBlock(blueBlock21);
	blockPlate1->AddBlueBlock(blueBlock22);
	blockPlate1->AddBlueBlock(blueBlock23);
	blockPlate1->AddBlueBlock(blueBlock24);
	blockPlate1->AddBlueBlock(blueBlock25);
	blockPlate1->AddBlueBlock(blueBlock26);
	blockPlate1->AddBlueBlock(blueBlock27);
	blockPlate1->AddBlueBlock(blueBlock28);
	blockPlate1->AddBlueBlock(blueBlock29);
	blockPlate1->AddBlueBlock(blueBlock30);
	blockPlate1->AddBlueBlock(blueBlock31);
	blockPlate1->AddBlueBlock(blueBlock32);
	AddObject(blockPlate1);

	std::shared_ptr<BlockPlate> blockPlate2 = std::make_shared<BlockPlate>();
	blockPlate2->Init("Asset/Data/Json/Stage/Stage5/PressurePlate/BlockPlate/BlockPlate2.json", blockPlateID++);
	//ブロックの情報を渡す
	...
	blockPlate2->AddBlueBlock(blueBlock21);
	blockPlate2->AddBlueBlock(blueBlock22);
	blockPlate2->AddBlueBlock(blueBlock23);
	blockPlate2->AddBlueBlock(blueBlock24);
	blockPlate2->AddBlueBlock(blueBlock25);
	blockPlate2->AddBlueBlock(blueBlock26);
	blockPlate2->AddBlueBlock(blueBlock27);
	blockPlate2->AddBlueBlock(blueBlock28);
	blockPlate2->AddBlueBlock(blueBlock29);
	blockPlate2->AddBlueBlock(blueBlock30);
	blockPlate2->AddBlueBlock(blueBlock31);
	blockPlate2->AddBlueBlock(blueBlock32);
	AddObject(blockPlate2);

	int fencePlateID = 1;
	std::shared_ptr<FencePlate> fencePlate1 = std::make_shared<FencePlate>();
	fencePlate1->Init("Asset/Data/Json/Stage/Stage5/PressurePlate/FencePlate/FencePlate1.json", fencePlateID++);
	...
	star1->Init("Asset/Data/Json/UI/Star/Stage5/Star1.json");
	AddObject(star1);

	std::shared_ptr<Star> star2 = std::make_shared<Star>();
	star2->Init("Asset/Data/Json/UI/Star/Stage5/Star2.json");
	AddObject(star2);

	std::shared_ptr<Star> star3 = std::make_shared<Star>();
	star3->Init("Asset/Data/Json/UI/Star/Stage5/Star3.json");
	AddObject(star3);
	//==================================================//
	...
	clearTime1->Init("Asset/Data/Json/UI/ClearTime/Stage5/ClearTime1.json");
	AddObject(clearTime1);

	std::shared_ptr<ClearTime> clearTime2 = std::make_shared<ClearTime>();
	clearTime2->Init("Asset/Data/Json/UI/ClearTime/Stage5/ClearTime2.json");
	AddObject(clearTime2);

	std::shared_ptr<ClearTime> clearTime3 = std::make_shared<ClearTime>();
	clearTime3->Init("Asset/Data/Json/UI/ClearTime/Stage5/ClearTime3.json");
