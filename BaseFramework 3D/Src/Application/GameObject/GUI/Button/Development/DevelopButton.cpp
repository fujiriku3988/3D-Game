#include "DevelopButton.h"
#include"../../../../main.h"
#include"../../../../GameObject/Camera/CameraBase.h"
#include"../../../../Scene/SceneManager.h"
#include"../../../../Fade/Fade.h"

void DevelopButton::Init()
{
	ButtonBase::Init();
	m_Spos = { 300,0 };
	m_scale = { 0.7f,0.7f };
...
void DevelopButton::Update()
{
	//if (SceneManager::Instance().GetModeType() == SceneManager::ModeType::GameHome)
	{
		POINT nowPos;
		GetCursorPos(&nowPos);
		...
		if (m_rotFlg)
		{
			...
			Fade::Instance().BootWhiteFade(SceneManager::SceneType::GameDevelop);
			//SceneManager::Instance().SetNextScene(SceneManager::SceneType::GameDevelop);
		}
