...
#include "GameScene/Stage5/StageScene5.h"
...
void SceneManager::Update()
{
	...
	ImGuiManager::Instance().RegisterObjects();
}
...
KdGameObject* SceneManager::GetObjectByName(const std::string& name)
{
...
void SceneManager::ChangeScene(SceneType sceneType)
{
	...
	case SceneType::Stage4:
		...
		break;
	case SceneType::Stage5:
		m_currentScene = std::make_shared<StageScene5>();
		break;
	default:
		break;
	}
