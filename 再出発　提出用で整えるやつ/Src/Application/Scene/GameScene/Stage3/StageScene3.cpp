...
void StageScene3::Init()
{
	...
	goalPoint->Init("Asset/Data/Json/Stage/Stage3/GoalPoint/GoalPoint.json",goalID++);
	AddObject(goalPoint);
	...
	blueBlock1->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock1.json", blockID++);
	AddObject(blueBlock1);

	std::shared_ptr<BlueBlock> blueBlock2 = std::make_shared<BlueBlock>();
	blueBlock2->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock2.json", blockID++);
	AddObject(blueBlock2);

	std::shared_ptr<BlueBlock> blueBlock3 = std::make_shared<BlueBlock>();
	blueBlock3->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock3.json", blockID++);
	AddObject(blueBlock3);

	std::shared_ptr<BlueBlock> blueBlock4 = std::make_shared<BlueBlock>();
	blueBlock4->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock4.json", blockID++);
	AddObject(blueBlock4);

	std::shared_ptr<BlueBlock> blueBlock5 = std::make_shared<BlueBlock>();
	blueBlock5->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock5.json", blockID++);
	AddObject(blueBlock5);

	std::shared_ptr<BlueBlock> blueBlock6 = std::make_shared<BlueBlock>();
	blueBlock6->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock6.json", blockID++);
	AddObject(blueBlock6);

	std::shared_ptr<BlueBlock> blueBlock7 = std::make_shared<BlueBlock>();
	blueBlock7->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock7.json", blockID++);
	AddObject(blueBlock7);

	std::shared_ptr<BlueBlock> blueBlock8 = std::make_shared<BlueBlock>();
	blueBlock8->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock8.json", blockID++);
	AddObject(blueBlock8);

	std::shared_ptr<BlueBlock> blueBlock9 = std::make_shared<BlueBlock>();
	blueBlock9->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock9.json", blockID++);
	AddObject(blueBlock9);

	std::shared_ptr<BlueBlock> blueBlock10 = std::make_shared<BlueBlock>();
	blueBlock10->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock10.json", blockID++);
	AddObject(blueBlock10);

	std::shared_ptr<BlueBlock> blueBlock11 = std::make_shared<BlueBlock>();
	blueBlock11->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock11.json", blockID++);
	AddObject(blueBlock11);

	std::shared_ptr<BlueBlock> blueBlock12 = std::make_shared<BlueBlock>();
	blueBlock12->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock12.json", blockID++);
	AddObject(blueBlock12);

	std::shared_ptr<BlueBlock> blueBlock13 = std::make_shared<BlueBlock>();
	blueBlock13->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock13.json", blockID++);
	AddObject(blueBlock13);

	std::shared_ptr<BlueBlock> blueBlock14 = std::make_shared<BlueBlock>();
	blueBlock14->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock14.json", blockID++);
	AddObject(blueBlock14);

	std::shared_ptr<BlueBlock> blueBlock15 = std::make_shared<BlueBlock>();
	blueBlock15->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock15.json", blockID++);
	AddObject(blueBlock15);

	std::shared_ptr<BlueBlock> blueBlock16 = std::make_shared<BlueBlock>();
	blueBlock16->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock16.json", blockID++);
	AddObject(blueBlock16);

	std::shared_ptr<BlueBlock> blueBlock17 = std::make_shared<BlueBlock>();
	blueBlock17->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock17.json", blockID++);
	AddObject(blueBlock17);

	std::shared_ptr<BlueBlock> blueBlock18 = std::make_shared<BlueBlock>();
	blueBlock18->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock18.json", blockID++);
	AddObject(blueBlock18);

	std::shared_ptr<BlueBlock> blueBlock19 = std::make_shared<BlueBlock>();
	blueBlock19->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock19.json", blockID++);
	AddObject(blueBlock19);

	std::shared_ptr<BlueBlock> blueBlock20 = std::make_shared<BlueBlock>();
	blueBlock20->Init("Asset/Data/Json/Stage/Stage3/BlueBlock/BlueBlock20.json", blockID++);
	...
	blockPlate1->Init("Asset/Data/Json/Stage/Stage3/PressurePlate/BlockPlate/BlockPlate1.json", blockPlateID++);
	//ブロックの情報を渡す
	...
	blockPlate2->Init("Asset/Data/Json/Stage/Stage3/PressurePlate/BlockPlate/BlockPlate2.json", blockPlateID++);
	//ブロックの情報を渡す
	...
	star1->Init("Asset/Data/Json/UI/Star/Stage3/Star1.json");
	AddObject(star1);

	std::shared_ptr<Star> star2 = std::make_shared<Star>();
	star2->Init("Asset/Data/Json/UI/Star/Stage3/Star2.json");
	AddObject(star2);

	std::shared_ptr<Star> star3 = std::make_shared<Star>();
	star3->Init("Asset/Data/Json/UI/Star/Stage3/Star3.json");
	AddObject(star3);
	//==================================================//
