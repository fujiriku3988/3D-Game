...
void StageScene1::Init()
{
	...
	clearStar1->Init("Asset/Data/Json/UI/ClearStar/GameScene/Stage1/ClearStar1.json");
	AddObject(clearStar1);

	std::shared_ptr<ClearStar> clearStar2 = std::make_shared<ClearStar>();
	clearStar2->Init("Asset/Data/Json/UI/ClearStar/GameScene/Stage1/ClearStar2.json");
	AddObject(clearStar2);

	std::shared_ptr<ClearStar> clearStar3 = std::make_shared<ClearStar>();
	clearStar3->Init("Asset/Data/Json/UI/ClearStar/GameScene/Stage1/ClearStar3.json");
