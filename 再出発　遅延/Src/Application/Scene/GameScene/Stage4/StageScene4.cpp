...
void StageScene4::Init()
{
	...
	goalPoint->Init("Asset/Data/Json/Stage/Stage4/GoalPoint/GoalPoint.json");
	AddObject(goalPoint);
	...
	blueBlock1->Init("Asset/Data/Json/Stage/Stage4/BlueBlock/BlueBlock1.json");
	AddObject(blueBlock1);
	//=================ブロック=================//

	//=================感圧式スイッチ=================//
	std::shared_ptr<BlockPlate> blockPlate1 = std::make_shared<BlockPlate>();
	blockPlate1->Init("Asset/Data/Json/Stage/Stage4/PressurePlate/BlockPlate/BlockPlate1.json");
	//ブロックの情報を渡す
